...
export const TopNavbar: React.FC<TopNavbarProps> = ({
  ...
  return (
    <header 
      id="kava-top-navbar"
      className="bg-white border-b border-[#E7E9ED] px-8 py-3.5 flex items-center justify-between sticky top-0 z-30 shadow-[0_1px_3px_rgba(0,0,0,0.02)]"
    >
      ...
      <div>
        ...
        <h2 className="text-xl font-bold text-[#1F2633] tracking-tight font-serif-heading">
          {getTabTitle()}
        </h2>
      </div>
      ...
      <div className="flex items-center space-x-3.5">
        ...
        <div className="relative" ref={roleRef}>
          <button
            ...
            className="flex items-center space-x-2 bg-white hover:bg-[#F9FAFB] text-[#374151] border border-[#D5DAE1] rounded-lg px-3 py-1.5 text-xs font-medium transition-all shadow-sm"
          >
