...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <aside 
      id="kava-sidebar"
      className="w-64 bg-[#141618] text-[#9EA6B0] flex flex-col justify-between border-r border-[#22272B] min-h-screen shrink-0 select-none"
    >
      {/* Top Brand & Role Container */}
      <div className="flex flex-col">
        {/* Brand Header */}
        <div className="p-6 pb-5 flex items-center space-x-3.5 border-b border-[#20252A]/80">
      ...
      <div className="p-4 mx-3 mb-4 bg-[#191D21] border border-[#262C33] rounded-lg">
